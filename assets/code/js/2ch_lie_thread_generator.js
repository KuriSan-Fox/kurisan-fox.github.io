...
function thread_render(){
    ...
    document.writeln('<br>1 ：<span style="color:green;' + thread_owner_custom_name_style + '">' + thread_owner_name + '</span>：' + (thread_res_creation.getFullYear()) + '/' + (thread_res_creation.getMonth()+1) + '/' + (thread_res_creation.getDate()) + '（' + thread_res_youbi[thread_res_creation.getDay()] + '） ' + thread_res_creation.getHours() + ':' + thread_res_creation.getMinutes() + ':' + thread_res_creation.getSeconds() + '<small style="color:gray;">.' + Math.floor(thread_res_creation.getMilliseconds()*0.1) + '</small>' + ' ID: ' + thread_owner_ID);
